...
module.exports = function(options) {
    ...
    socket.on('connection', function(client) {
        ...
        client.on('disconnect', function() {
            ...
            broadcastConnectInfo(viewing, 'disconnect');
        });

        function broadcastConnectInfo(target, action) {
            sendInfoToViewers(viewing, action);
            sendToViewers(viewing, {
                stat: {
                    viewers: viewers[viewing],
                    editing: editors[viewing]
                }
            });
            sendToViewers('/', {
                connections: {
        ...
        function addToViewers(target) {
            ...
            broadcastConnectInfo(viewing, 'connect');
        }
